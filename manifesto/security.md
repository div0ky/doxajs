...
| Stale asynchronous authority                | System worker authority by default; impersonated work snapshots target and attribution when accepted, while stop blocks future dispatch                     | Queue stop/restart durable-context regression                                                           |
