...
| Graphite datetimes                     | Complete | Native Temporal values, execution-owned clocks, strict zones and precision, UTC PostgreSQL persistence, boundary codecs, and isolated test time travel are proven.                              |
